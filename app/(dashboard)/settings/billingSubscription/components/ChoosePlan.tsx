  ...
  return (
    <div className="flex flex-col md:flex-row justify-between py-4 gap-4 border-[#E9EAEB] border-b">
      ...
      <div className="w-full md:w-[80%] border border-[#EDEDED] rounded-[8px] p-4 flex flex-col gap-2 ">
        <div className="flex md:hidden items-center flex-col gap-2">
          <div className="flex justify-between items-center w-full">
            <h2 className="text-[#1F1F1F] text-xl font-[500]">
              Select New Plan
            </h2>
            <div className="bg-[#F1F1F1] flex p-1 rounded-[16px] w-fit">
              {buttons.map((button) => (
                <Button
                  key={button.id}
                  onClick={() => setValue(button.id)}
                  className={`
        py-3 px-[9px]  rounded-[6px]  text-xs font-[500]
        ${
          value === button.id
        ...
        `}
          ...
          <div className="flex justify-end items-end w-[40%]"></div>
        </div>
