        ...
        <div className="p-6 gap-5 flex flex-col">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-[20px]">
            ...
            <div className="flex flex-col gap-2">
              <label
                htmlFor="sku-code"
                className="block text-left font-circular-normal text-[#717171] text-[14px]"
              >
                SKU Code
              </label>
              <input
                type="text"
                name="sku-code"
                className="w-full h-[48px] md:h-[62px] rounded-[9px] p-[12px] outline-none border border-[#DEDEDE]  text-[#2A2A2A] text-[16px] font-circular-normal bg-[#F6F8FA]"
