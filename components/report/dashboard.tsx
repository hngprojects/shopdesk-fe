  ...
  return (
    <div className="pb-6 bg-white">
      ...
      <div className="px-2 py-4 gap-[19px] bg-white rounded-bl-2xl flex justify-center items-center">
        ...
        <button className="bg-white text-[16px] lg:hidden gap-[6px] flex h-[48px] items-center justify-center text-black p-3.5 rounded-[12px] border border-[#1B1B1B ]" onClick={openExportModal}>
          <ArrowUp className="size-[18px]"/>
        </button>
      </div>
        </div>
          ...
          <div className="p-[20px]">
            <div className="lg:grid flex flex-col md:grid-cols-4 gap-4 mb-6">
              {metrics.map((metric, index) => (
                <div key={index} className="bg-white flex flex-col rounded shadow">
                  <div className="flex items-center w-full gap-2 lg:gap-[12px] pt-5 pb-5 pl-3">
                    ...
                    <h2 className="text-[14px] lg:text-[16px] font-medium text-gray-500">{metric.title}</h2>
                  </div>
                      ...
                      return (
                        <>
                          ...
                          <p className="text-xs mt-1">
                            <span className={`px-2 py-1 rounded ${isPositive ? 'bg-green-100' : 'bg-red-100'} ${colorClass}`}>
